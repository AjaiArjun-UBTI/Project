...
router.get("/claim-status", async (_req: Request, res: Response) => {
  try {
...
/* ---------- GET ALL CLAIM TYPES ---------- */
router.get("/claim-types", async (_req: Request, res: Response) => {
  try {
...
router.get("/user-approver-map", async (req: Request, res: Response) => {
  try {
